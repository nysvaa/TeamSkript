		...
		try {
			...
			api.addTS3Listeners(new TS3Listener() {
				...
				public void onClientLeave(ClientLeaveEvent e) {
					TeamSkript.getInstance().getServer().getPluginManager().callEvent(new TsClientLeaveEvent(e.getInvokerName()));
				}

				@Override
				public void onClientJoin(ClientJoinEvent e) {
					TeamSkript.getInstance().getServer().getPluginManager().callEvent(new TsClientJoinEvent(api.getClientByNameExact(e.getInvokerName(), false)));
				}
			...
			TeamSkript.getInstance().getLogger().warning("Tried to connect to " + host + " but don't succeed");
